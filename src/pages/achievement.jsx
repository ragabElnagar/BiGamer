            ...
            <div className="achievement-area">
              ...
              >
                <li className="nav-item" role="presentation" title="Pubg Lite">
                  ...
                  >
                    <img
                      src="assets/images/achivement/01.png"
                      alt="achievement"
                    />
                  </button>
                </li>
                ...
                >
                  ...
                  >
                    <img
                      src="assets/images/achivement/02.png"
                      alt="achievement"
                    />
                  </button>
                </li>
                <li className="nav-item" role="presentation" title="Valorant">
                  ...
                  >
                    <img
                      src="assets/images/achivement/03.png"
                      alt="achievement"
                    />
                  </button>
                </li>
                ...
                >
                  <button
                    ...
                    id="tabFour-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#tabFour"
                    type="button"
                    role="tab"
                    aria-controls="tabFour"
                    aria-selected="false"
                  >
                    <img
                      src="assets/images/achivement/04.png"
                      alt="achievement"
                    />
                  </button>
                </li>
                ...
                >
                  <button
                    ...
                    id="tabFive-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#tabFive"
                    type="button"
                    role="tab"
                    aria-controls="tabFive"
                    aria-selected="false"
                  >
                    <img
                      src="assets/images/achivement/05.png"
                      alt="achievement"
                    />
                  </button>
                </li>
                ...
                >
                  <button
                    ...
                    id="tabSix-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#tabSix"
                    type="button"
                    role="tab"
                    aria-controls="tabSix"
                    aria-selected="false"
                  >
                    <img
                      src="assets/images/achivement/06.png"
                      alt="achievement"
                    />
                  </button>
                </li>
                <li className="nav-item" role="presentation" title="Epic Games">
                  <button
                    ...
                    id="tabSeven-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#tabSeven"
                    type="button"
                    role="tab"
                    aria-controls="tabSeven"
                    aria-selected="false"
                  >
                    <img
                      src="assets/images/achivement/07.png"
                      alt="achievement"
                    />
                  </button>
                </li>
