                        ...
                        >
                          <div className="accordion-body">
                            <p>
                              ...
                              elit. Libero voluptas provident qui corporis
                              facere officia numquam, repelat, vel ameting velit
                              quidem culpa vitae error ex porro voluptates a
                              veritatis sed illum doloring inventore blanditiis
                              impedit! Aliquid, amet ipsa, tenetur nisit
                              perferendisi excepturi, commodi nobis eligendi
                              harum iure exercita.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="accordion-header" id="headingSeven">
                          ...
                          >
                            <span className="accor-header-inner d-flex flex-wrap align-items-center">
                              <span className="accor-thumb">
                                <img
                                  src="assets/images/sponsor/07.png"
                                  alt="partner-thumb"
                                />
                              </span>
                        ...
                        <div className="accordion-header" id="headingEight">
                          ...
                          >
                            <span className="accor-header-inner d-flex flex-wrap align-items-center">
                              <span className="accor-thumb">
                                <img
                                  src="assets/images/sponsor/08.png"
                                  alt="partner-thumb"
                                />
                              </span>
