...
function BlogDetails() {
  return (
    <Fragment>
      <Header />
      <PageHeader
        title={"SERENITY HASSIR TAKEN POSSESON..."}
        curPage={"Blog Details"}
      />
                ...
                <article>
                    ...
                    <div className="post-inner">
                      ...
                      <div className="post-content">
                        ...
                        <ul className="lab-ul post-date">
                          <li>
                            <span>
                              <i className="icofont-ui-calendar"></i> October 9,
                              2021 10:59 am
                            </span>
                          </li>
                          <li>
                        ...
                        <blockquote className="single-quote mb-30">
                          <div className="quotes">
                            ...
                            wherease turnkey channels and onotonec provide aces
                            to resource levelng expert vias worldwide deverabes
                            uoliticly extend aserser are diverse vortals.
                        ...
                        <div className="post-thumb mb-30">
                          ...
                          />
                          <a
                            href="https://www.youtube.com/embed/ZgMw__KdjiI"
                            className="play-btn"
                            target="_blank"
                          >
                  ...
                  <div className="article-pagination">
                    <div className="prev-article">
                      <a href="#">
                        <i className="icofont-rounded-double-left"></i>Previous
                        Article
                      </a>
                      <p>
