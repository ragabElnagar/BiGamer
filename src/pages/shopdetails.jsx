...
function ShopDetails() {
  const [reviwName, setReviwName] = useState("");
  const [reviwEmail, setReviwEmail] = useState("");
  const [reviwMassage, setReviwMassage] = useState("");
                          ...
                          <form action="action" className="row">
                            ...
                            <div className="col-md-12 col-12">
                              <textarea
                                ...
                                value={reviwMassage}
                                onChange={(e) => {
                                  setReviwMassage(e.target.value);
                                }}
